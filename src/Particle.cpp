...
void ParticleSystem::fuel(int particles)
{
	for (int i = 0; i < particles; i++)
	{
		...
		particle->drawVertex.color.r = m_transparent.r/*randomColor(gen)*/;
		particle->drawVertex.color.g = m_transparent.g/*randomColor(gen)*/;
		particle->drawVertex.color.b = m_transparent.b/*randomColor(gen)*/;
